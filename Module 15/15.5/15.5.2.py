...
numbers = [
    1014, 1321, 675, 1215, 56, 1386, 1385, 431, 1058, 486, 1434, 696, 1016, 1084,
    ...
    898, 669, 105, 130, 1363, 947, 72, 1278, 166, 904, 349, 831, 1207, 1496, 370,
    725, 926, 175, 959, 1282, 336, 1268, 351, 1439, 186, 273, 1008, 231, 138, 142,
    433, 456, 1268, 1018, 1274, 387, 120, 340, 963, 832, 1127
]

# Фильтр трехзначных чисел, которые при делении на 5 дают остаток 2
filtered_numbers = filter(lambda x: 100 <= x <= 999 and x % 5 == 2, numbers)

# Преобразование оставшихся чисел в их кубы
cubes = map(lambda x: x ** 3, filtered_numbers)

# Вывод каждого куба на отдельной строке
for cube in cubes:
    print(cube)
