...
# На вход программе подаются два числа n и m — количество строк и столбцов в матрице, далее идут n × m слов, каждое
# на отдельной строке.
...
# Вывод матрицы с поменяными строками и столбцами
for j in range(m):
    for i in range(n):
