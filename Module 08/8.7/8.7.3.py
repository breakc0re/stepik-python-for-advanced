...
print(*sorted(student_1.intersection(student_2).difference(student_3), reverse=True))

# Решение № 2 (однострочное)

print(*sorted(set(map(int, input().split())).intersection(set(map(int, input().split()))).difference(
