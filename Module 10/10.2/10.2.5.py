...
# Программа должна вывести номер курса, затем номер аудитории, имя преподавателя и время
# проведения курса в соответствии с примерами.
...
print(f'{course}: {info[course][0]}, {info[course][1]}, {info[course][2]}')
